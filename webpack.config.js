...
module.exports = (_env, argv) => {
  ...
  return {
    entry: {
      ...
      'validacao-dashboard/validacao-dashboard': './src/validacao-dashboard/validacao-dashboard.ts',
      ...
      'prevjud-painel/painel': './src/prevjud-painel/painel.ts',
      'prevjud-dashboard/prevjud-dashboard': './src/prevjud-dashboard/prevjud-dashboard.ts',
      'pauta-pericia-painel/painel': './src/pauta-pericia-painel/painel.ts',
      'pauta-pericia-dashboard/pauta-pericia-dashboard': './src/pauta-pericia-dashboard/pauta-pericia-dashboard.ts',
    ...
    plugins: [
      new CopyPlugin({
        patterns: [
          ...
          { from: 'src/validacao-dashboard/validacao-dashboard.html', to: 'validacao-dashboard/validacao-dashboard.html' },
          { from: 'src/validacao-dashboard/validacao-dashboard.css', to: 'validacao-dashboard/validacao-dashboard.css' },
          ...
          { from: 'src/prevjud-painel/painel.html', to: 'prevjud-painel/painel.html' },
          { from: 'src/prevjud-painel/painel.css', to: 'prevjud-painel/painel.css' },
          { from: 'src/prevjud-dashboard/prevjud-dashboard.html', to: 'prevjud-dashboard/prevjud-dashboard.html' },
          { from: 'src/prevjud-dashboard/prevjud-dashboard.css', to: 'prevjud-dashboard/prevjud-dashboard.css' },
          { from: 'src/pauta-pericia-painel/painel.html', to: 'pauta-pericia-painel/painel.html' },
          { from: 'src/pauta-pericia-painel/painel.css', to: 'pauta-pericia-painel/painel.css' },
          { from: 'src/pauta-pericia-dashboard/pauta-pericia-dashboard.html', to: 'pauta-pericia-dashboard/pauta-pericia-dashboard.html' },
          { from: 'src/pauta-pericia-dashboard/pauta-pericia-dashboard.css', to: 'pauta-pericia-dashboard/pauta-pericia-dashboard.css' },
